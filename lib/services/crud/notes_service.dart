...
class DatabaseNote {
  ...
  final int userId;
  final String text;
  final bool isSyncedWithClouds;

  DatabaseNote({
    required this.id,
    required this.userId,
    required this.text,
    required this.isSyncedWithClouds,
  });
  ...
  @override
  String toString() =>
      'Note, ID = $id, userId = $userId, isSyncedWithCloud = $isSyncedWithClouds, text = $text';
